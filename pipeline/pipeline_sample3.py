# -*- coding: utf-8 -*-
"""
pleline_sample(BigQuery to BigQuery)
"""
...
def run(argv=None):
  ...
  p3 = beam.Pipeline(options=pipeline_options) #in→bigquery out→textのパイプライン
  ...
  p3 | 'read' >> Read(beam.io.BigQuerySource(project='gcp-project-210712', use_standard_sql=False, query=query)) \
     | 'write' >> beam.io.Write(beam.io.BigQuerySink( \
        'babynames.testtable1',schema='name:string, gender:string, count:integer', \
